...
for ker in ['linear','poly','rbf','sigmoid','precomputed']:
  svm.set_params(kernel=ker)
  svm.fit(data_train,label_train)
  predictions=svm.predict(data_dev)
  this_score=roc_auc_score(label_dev,predictions)
  print("kernel=",ker," ,score=",this_score)
  if this_score>score:
    score=this_score
    set_kernel=kernel
svm.set_params(kernel=set_kernel)
print('---------Best Model----------')
print("kernel=",set_kernel)
...
test_res=svm.predict_proba(test_list)
